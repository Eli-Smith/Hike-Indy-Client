...
function App() { // Declaring our App Component
  ...
  const AuthViews = () =>{ // Creating a function to decide what should be rendered to the screen
    return sessionToken !== undefined ? <Splash token={sessionToken}/> : <Auth setSession={setSessionToken}/> // Using a ternary to determine whether or not our jwt is undefined or not. If it is not undefiniend, show our splash page and pass it our token as a prop. If it is undefined, display our Auth page and pass it our setSessionToken callback function as a prop
  }
  return (
    <div className="App">
